...
const ForgetPatternEmailVerify = React.lazy(() =>
  import('./views/pages/ForgetPattern/ForgetPatternEmailVerify'),
)
...
const routes = [
  ...
  { path: '/forgetPassword', name: 'forgetPassword', element: ForgetPatternEmailVerify },
