...
const SetNewPassword = () => {
  ...
  return (
    <>
      <div className="p-4 twoFactor-Bg bg-body-secondary row text-center justify-content-center" style={{ minHeight: '100vh' }}>
        <div className="my-5">
          <div className="row">
            <div className="col-lg-6">
              <form onSubmit={handleSubmit(handleSetNewPassword)}>
                <div className="mb-5">
                  <h1 className='text-danger ms-5 row text-center justify-content-center'>Set Your Password</h1>
                  <div className="my-3">
                    <>
                      <input
